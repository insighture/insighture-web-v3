		...
		>
			...
			{sorted.length > 0 && (
				<div className="flex flex-col gap-[16px]">
					...
					{/* Cards row with arrows on both sides */}
					<div className="flex items-center gap-[16px]">
						...
						{isCarousel && (
							<button
								...
								disabled={page === 0}
								aria-label="Previous"
								className="size-[40px] shrink-0 rounded-full border border-[#7B858A] bg-[rgba(255,255,255,0.9)] shadow-[1px_1px_4px_0_#CED7DB] flex items-center justify-center transition-all hover:shadow-md disabled:opacity-30"
						...
						{/* CARDS GRID */}
						<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[16px] flex-1">
							{visible.map((card) => (
								<div
									key={card.id}
