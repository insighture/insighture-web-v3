...
const Footer = forwardRef<HTMLElement, FooterProps>(({ navigation, globals }, ref) => {
	...
	const ctaButtonHref =
		footerCTA?.footer_cta_button_page?.permalink || footerCTA?.footer_cta_button_url || '/lets-talk';
	...
	return (
		<>
			{pathname === '/lets-talk' && (
				<div className="w-full bg-[#ebf0f2] py-10 md:py-10">
					<Container>
						<p
						...
						>
							Insighture acknowledges the Traditional Owners of the land on which we work and live and pay our respects
							to Elders past and present. We recognise and respect the continuing cultures, contributions and connection
							to Country of Aboriginal and Torres Strait Islander peoples.
						</p>
					</Container>
				</div>
			)}
				...
				{pathname !== '/lets-talk' && (
					...
					>
						...
						<div className="relative z-10 flex flex-col items-center gap-[24px] md:gap-[32px] py-[48px] md:py-[64px] lg:py-[84px] px-4">
							...
							>
								<span className="font-heading font-bold text-[16px] leading-[26px] text-[#f7f7f7]">
									{ctaButtonText}
								</span>
